...
function Sidebar({ result }) {
  ...
  return <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-5 space-y-6">
    <div className="flex items-center gap-2">
      <span className="text-xl">🧷</span>
      <h3 className="text-lg font-semibold text-indigo-600">Quick Exam Sidebar</h3>
    </div>
    ...
    <section>
      ...
      </p>
      {
        Object.entries(result.subTopics).map(([star, topics]) => (
          <div className="mb-3 rounded-lg bg-gray-50 border border-gray-200 p-3" key={star}>
