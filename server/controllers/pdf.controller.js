...
export const pdfDownload = async (req, res) => { 
        ...
        res.setHeader('Content-Disposition', 'attachment; filename="ExamNotesAi-Subhashis.pdf"');

        doc.pipe(res);

        doc.fontSize(20).text("ExamNotesAI - Subhashis", { align: 'center' });
        doc.moveDown();
        ...
        // Notes
        doc.fontSize(16).text("Exam Notes");
        doc.moveDown(0.5);
        doc.fontSize(12).text(result.notes.replace(/[#*]/g, '')); // Remove markdown symbols for PDFs
        ...
        doc.moveDown(0.5);
        doc.fontSize(13).text("Diagram-based Questions:");
